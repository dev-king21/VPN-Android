...
import huanjing.vpn.android.activities.ConfirmAPIActivity;
import huanjing.vpn.android.activities.GrantPermissionsActivity;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp) {
            ...
            if (vpnPermissionIntent != null || needpw != 0) {
                ...
                shortVPNIntent.setClass(getBaseContext(), huanjing.vpn.android.LaunchVPN.class);
                shortVPNIntent.putExtra(huanjing.vpn.android.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(huanjing.vpn.android.LaunchVPN.EXTRA_HIDELOG, true);
