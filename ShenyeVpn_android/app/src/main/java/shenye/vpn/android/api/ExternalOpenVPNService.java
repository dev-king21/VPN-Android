...
import shenye.vpn.android.activities.ConfirmAPIActivity;
import shenye.vpn.android.activities.GrantPermissionsActivity;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp) {
            ...
            if (vpnPermissionIntent != null || needpw != 0) {
                ...
                shortVPNIntent.setClass(getBaseContext(), shenye.vpn.android.LaunchVPN.class);
                shortVPNIntent.putExtra(shenye.vpn.android.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(shenye.vpn.android.LaunchVPN.EXTRA_HIDELOG, true);
        ...
        public void startProfile(String profileUUID) throws RemoteException {
            ...
            if (vp.checkProfile() != R.string.no_error_found)
                throw new RemoteException(getString(vp.checkProfile()));
